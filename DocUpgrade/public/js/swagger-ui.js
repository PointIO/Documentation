...
//                log("li_content_dom_id " + li_content_dom_id);
    ...
    //show code
    var codeId = resource.split("\\.")[0] + "Code"
...
function program1(depth0,data) {
  ...
  buffer += "\n<div class='container' id='resources_container'>\n    <ul id='resources'>\n    </ul>\n\n    <div class=\"footer\">\n        <br>\n        <br>\n        <h4 style=\"color: #999\">[ <span style=\"font-variant: small-caps\">base url</span>: http://api.point.io\n        ";
...
function program11(depth0,data) {
  ...
  return "\n                    <div class='sandbox_header'>\n                        <input class='submit' name='commit' type='button' value='Make the call!' />\n                        <a href='#' class='response_hider' style='display:none'>Hide Response</a>\n                        <img alt='Throbber' class='response_throbber' src='images/throbber.gif' style='display:none' />\n                    </div>\n                    ";
  }
  ...
  HeaderView = (function(_super) {
    ...
    HeaderView.prototype.showPetStore = function(e) {
      return this.trigger('update-swagger-ui', {
        discoveryUrl: "http://www.pointio.info/sites/default/files/tutorials.json",
        apiKey: "special-key"
      });
    };
